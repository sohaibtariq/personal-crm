// <copyright file="OpenAIAPIClient.cs" company="APIMatic">
...
namespace OpenAIAPI.Standard
{
    ...
    /// </summary>
    public sealed class OpenAIAPIClient : IConfiguration
    {
        ...
        {
            {
                ...
                {
                    { Server.Default, "https://api.openai.com/v1" },
                }
            },
        };
        ...
        private readonly Lazy<OpenAIController> openAI;
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.openAI = new Lazy<OpenAIController>(
                () => new OpenAIController(this, this.httpClient, this.authManagers, this.httpCallBack));
        ...
        /// <summary>
        /// Gets OpenAIController controller.
        /// </summary>
        public OpenAIController OpenAIController => this.openAI.Value;
        ...
        /// <summary>
        /// Creates an object of the OpenAIAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> OpenAIAPIClient.</returns>
        internal static OpenAIAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("OPEN_AIAPI_STANDARD_ENVIRONMENT");
            string accessToken = System.Environment.GetEnvironmentVariable("OPEN_AIAPI_STANDARD_ACCESS_TOKEN");
        ...
        {
            private Environment environment = OpenAIAPI.Standard.Environment.Production;
