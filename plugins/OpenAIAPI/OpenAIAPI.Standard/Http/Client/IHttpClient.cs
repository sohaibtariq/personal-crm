...
namespace OpenAIAPI.Standard.Http.Client
{
    ...
    internal interface IHttpClient
    {
        ...
        /// <param name="retryConfiguration">The <see cref="RetryConfiguration"/> for request.</param>
        /// <returns> HttpResponse containing raw information.</returns>
        Task<HttpStringResponse> ExecuteAsStringAsync(HttpRequest request, RetryConfiguration retryConfiguration = null,
        ...
        /// <param name="retryConfiguration">The <see cref="RetryConfiguration"/> for request.</param>
        /// <returns> HttpResponse containing raw information.</returns>
        Task<HttpResponse> ExecuteAsBinaryAsync(HttpRequest request, RetryConfiguration retryConfiguration = null,
            CancellationToken cancellationToken = default);
